...
export const Score = ({ number, className }: { number: number; className?: string }) => {
	const normalized = number / 5;
	const hue = normalized * 120;

	return (
		<div
			className={`flex items-center justify-center leading-3 rounded-[10px] border-[2px] shadow-md p-1 ` + className}
