'use client';
import { Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Button, Input, DatePicker } from '@heroui/react';
...
export default function RegModal({ isOpen, onOpenChange }: { isOpen: boolean; onOpenChange: () => void }) {
	return (
			...
			<ModalContent>
				{(onClose) => (
					<>
						...
						<ModalBody>
							<Input color="success" label="Имя" placeholder="Введите имя" variant="bordered" />
							<Input color="success" label="Фамилия" placeholder="Введите фамилию" variant="bordered" />
							<Input
								color="success"
